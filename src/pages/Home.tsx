        ...
        <div className="container mx-auto px-6 pt-20 pb-32 relative">
          <div className="max-w-4xl">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-slide-in-left">
              Hi, I'm <span className="text-gradient from-[#C33764] to-[#1D2671]">Anshu</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-2xl animate-slide-in-right">
              A passionate <strong className='font-bold'>Web development</strong> crafting beautiful, user-centric web experiences
